...
constexpr GFX_FORMAT_SET GFX_FORMAT_R8G8B8A8_UNORM_SWAPCHAIN = { DXGI_FORMAT_R8G8B8A8_UNORM, DXGI_FORMAT_R8G8B8A8_UNORM, DXGI_FORMAT_UNKNOWN, DXGI_FORMAT_UNKNOWN };
constexpr GFX_FORMAT_SET GFX_FORMAT_R8G8B8A8_UNORM_SRGB_SWAPCHAIN = { DXGI_FORMAT_R8G8B8A8_UNORM, DXGI_FORMAT_R8G8B8A8_UNORM_SRGB, DXGI_FORMAT_UNKNOWN, DXGI_FORMAT_UNKNOWN };
...
constexpr GFX_FORMAT_SET GFX_FORMAT_HDR = GFX_FORMAT_R32G32B32A32_FLOAT;

constexpr D3D12_BLEND_DESC BLEND_STATE_ADD = { false, false,
	{
        {
            TRUE, FALSE,

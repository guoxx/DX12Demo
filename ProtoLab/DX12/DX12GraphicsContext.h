...
public:
	...
	void ClearDepthTarget(DX12DescriptorHandle& handle, float d);
	...
	void SetRenderTargets(uint32_t numColorSurfaces, DX12DescriptorHandle* pColorSurface, DX12DescriptorHandle* pDepthSurface);
